...
template <typename T>
void swap(DeallocatingVector<T> &lhs, DeallocatingVector<T> &rhs);
...
class DeallocatingVector
{
  ...
  public:
    ...
    friend void swap<>(DeallocatingVector<ElementT> &lhs,
                       DeallocatingVector<ElementT> &rhs);
    ...
    friend void storage::serialization::read<ElementT>(storage::io::FileReader &reader, DeallocatingVector &vec);
    friend void storage::serialization::write<ElementT>(storage::io::FileWriter &writer, const DeallocatingVector &vec);
};
